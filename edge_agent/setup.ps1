...
[System.IO.File]::WriteAllText("$INSTALL_DIR\.env", $envContent, (New-Object System.Text.UTF8Encoding $false))
...
[System.IO.File]::WriteAllText("$INSTALL_DIR\config.yaml", $configContent, (New-Object System.Text.UTF8Encoding $false))
